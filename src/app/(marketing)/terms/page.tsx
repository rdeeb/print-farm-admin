...
export const metadata: Metadata = {
  title: 'Terms of Service — 3D Farm Admin',
  description: 'Terms and conditions governing use of the 3D Farm Admin platform.',
}
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            By accessing or using 3D Farm Admin (&quot;Service&quot;), you agree to be bound by these Terms of Service
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            3D Farm Admin provides order management, cost tracking, print queue management, and analytics software
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2 leading-relaxed">
            ...
            <li>
              <strong>Cancellation:</strong> You may cancel at any time. Cancellation takes effect at the end of the
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            The Service and its original content, features, and functionality are owned by 3D Farm Admin and are
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            To the maximum extent permitted by law, 3D Farm Admin shall not be liable for any indirect, incidental,
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            You may cancel your account at any time from your account settings. Upon termination, your right to use
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <a href="mailto:legal@3dfarmadmin.com" className="text-indigo-600 hover:underline">
              legal@3dfarmadmin.com
            </a>
            .
          </p>
        </section>
